...
# Load data
data = io.mmread('intermediate_files/2_decontx_primate_data.mtx')
orig_data = sc.read_h5ad('intermediate_files/1_preprocessed_primate_data.h5ad')
...
sdata.write('processed_files/3_primate_all_cell_types_all_genes.h5ad')
