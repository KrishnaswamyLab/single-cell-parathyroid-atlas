...
# Save
sdata.write('intermediate_files/1_preprocessed_primate_data.h5ad')
sdata.obs['sample'].to_csv('intermediate_files/1_preprocessed_primate_data_sample_ids.csv')
io.mmwrite('intermediate_files/1_preprocessed_primate_data.mtx', sdata.X)
